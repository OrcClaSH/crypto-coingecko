  ...
  return (
    <div className={st.mockinf}>
      ...
      <span className={st.mockinf__comment}>
        If you click on the button, then change it to real data (perhaps the limit will
        still be in effect and will automatically change back to mocked data)
      </span>
      <Button className={st.mockinf__btn} onClick={handleCLick}>
        &#x2190; Refresh the page
      </Button>
    </div>
  );
