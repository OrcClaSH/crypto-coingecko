...
export const normalizeCoinDetail = (from: CoinDetailApi): CoinDetailModel => ({
  ...
  priceChangePercentage_1hInCurrency:
    from.market_data.price_change_percentage_1h_in_currency,
  ...
  priceChangePercentage_7dInCurrency:
    from.market_data.price_change_percentage_7d_in_currency,
  priceChangePercentage_14dInCurrency:
    from.market_data.price_change_percentage_14d_in_currency,
  priceChangePercentage_30dInCurrency:
    from.market_data.price_change_percentage_30d_in_currency,
  priceChangePercentage_60dInCurrency:
    from.market_data.price_change_percentage_60d_in_currency,
  priceChangePercentage_200dInCurrency:
    from.market_data.price_change_percentage_200d_in_currency,
  priceChangePercentage_1yInCurrency:
    from.market_data.price_change_percentage_1y_in_currency,
